...
app_server <- function( input, output, session ) {
  ...
  mod_qc_heat1000_server("qc_heat1000_ui_1",updata=updata)
  mod_qc_heatcor_server("qc_heatcor_ui_1",updata=updata)
  deg_data <- mod_deg_matrix_server("deg_matrix_ui_1", updata=updata)
  ...
  mod_deg_heat_server("deg_heat_ui_1", deg_data=deg_data, updata=updata)
}
